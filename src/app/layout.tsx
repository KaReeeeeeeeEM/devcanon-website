...
export const metadata: Metadata = { title: { default: "devcanon — Engineering standards, on command", template: "%s · devcanon" }, description: "Install a durable AI engineering handbook into any repository.", metadataBase: new URL("https://kareeeeeeeeem.github.io/devcanon-website/"), openGraph: { title: "devcanon", description: "Give every AI agent your engineering judgment.", type: "website" } };
